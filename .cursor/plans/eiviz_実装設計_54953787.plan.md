...
| NDI | Runtime wired（grafton-ndi 1.0.0、discovery、映像・音声receive/send、metadata/sender tally、NV12 BT.709、reconnect診断、Desktop接続） | NDI 6 SDK/runtime build、別PCinterop、receiver tally API非提供の制約確認、network fault/24h実証 |
