...
| DeckLink/Audio I/O | Runtime wired（SDK16 C++ shim capture/scheduled playback、CPAL WASAPI/CoreAudio/ALSA/PipeWire、explicit ASIO、明示ASRC） | SDK/hardware build、genlock/xrun/24h HIL |
