...
| Encode/stream | Runtime wired（Desktop mapping→Engine→encoder→shared AU fanout、RTMP/SRT/fMP4、reconnect/recovery） | production binary HIL、real-server/loss/24h |
