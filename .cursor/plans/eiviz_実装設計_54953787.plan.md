...
| Mixing/Audio/Output | Runtime wired（OutputごとのProgram/Multiview source選択、DAG/Follow/delay/pan、bounded sinc ASRC/drift/reset診断、CPAL callback静的realtime guard） | 実device xrun/drift/24h HIL |
