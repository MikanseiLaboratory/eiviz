...
| OMT | Runtime wired（pure-Rust openmediatransport-rs/vmx-rs、BGRA/UYVY、映像・音声receive/send、bounded metadata、visibility連動tally、reconnect診断、GUI接続） | 別PCinterop、network fault/24h実証 |
