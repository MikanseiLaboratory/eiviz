...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "settings.webApiHelp": "HTTP and TCP listen on all interfaces. HTTP default is 8088; TCP is fixed at 8099 with no auth. Empty username and password disable HTTP BasicAuth. Listen start, stop, and Function calls are written to the mixer log.",
    ...
    private static let ja: [String: String] = [
        ...
        "settings.webApiHelp": "HTTPとTCPはすべてのインターフェイスで待ち受けます。HTTPの既定は8088、TCPは8099固定で認証はありません。ユーザー名とパスワードを空にするとHTTPのBasicAuthは使いません。起動・停止とFunctionはMixerログに出ます。",
