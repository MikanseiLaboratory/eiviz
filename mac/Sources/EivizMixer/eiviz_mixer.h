...
int32_t mixer_set_video_gpu_upload(uint32_t enabled);
int32_t mixer_set_still_gpu_upload(uint32_t enabled);
int32_t mixer_set_omt_cpu_decode_ingest(uint32_t enabled);
int32_t mixer_set_omt_skip_jitter_copy(uint32_t enabled);
int32_t mixer_set_readback_off_clock(uint32_t enabled);
int32_t mixer_set_mf_import_no_wait(uint32_t enabled);
int32_t mixer_set_gpu_queue_lock_narrow(uint32_t enabled);
