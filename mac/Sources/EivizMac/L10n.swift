...
enum L10n {
    ...
    private static let en: [String: String] = [
        ...
        "settings.flipBudget": "Video output window limit",
        "settings.flipBudgetAuto": "Auto",
        "settings.flipBudgetHelp": "Limits Preview, Program, Multiview, and Scene Editor present surfaces. Auto starts at 6 and lowers the ceiling on this Mac if a new window makes existing outputs freeze. Scene tiles use CPU thumbnails and do not count.",
        "msg.flipBudget": "Video output windows are at the limit. Close one and try again.",
        "mv.top": "Top",
        "mv.bottom": "Bottom",
        "dialog.ok": "OK",
    ...
    private static let ja: [String: String] = [
        ...
        "settings.flipBudget": "映像出力窓の上限",
        "settings.flipBudgetAuto": "自動",
        "settings.flipBudgetHelp": "Preview / Program / Multiview / Scene Editor の映像出力面を制限します。自動は 6 から始め、新しい窓で既存出力が止まったらこの Mac の天井を下げます。シーンタイルは CPU サムネなので数えません。",
        "msg.flipBudget": "映像出力窓が上限です。どれかを閉じてください。",
        "mv.top": "上",
        "mv.bottom": "下",
        "dialog.ok": "OK",
        "dialog.cancel": "キャンセル",
