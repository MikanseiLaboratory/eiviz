...
pub use abi::{
    ...
    TRANSITION_DATAMOSH, TRANSITION_METAMIX, TRANSITION_MULTITASK, TRANSITION_PAGE_CURL, TRANSITION_PARTS, TRANSITION_PIXEL_SORT, TRANSITION_VISUAL_DISSOLVE,
...
fn render_loop(
    ...
    while !stop.load(Ordering::Relaxed) {
        ...
        if crate::diag::take_gpu_fault() {
            crate::diag::warn("gpu fault; invalidating presenters");
