...
**eiviz** (AY-viz) is a software vision mixer maintained by [Mikansei Laboratory](https://mikanseilaboratory.github.io/) and Shugo Kawamura / [FlowingSPDG](https://github.com/FlowingSPDG). Windows and macOS are supported. Linux is experimental.
